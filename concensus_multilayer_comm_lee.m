...
[B_g1, twom_g1] = multicat(A_g1, 1, 1);
...
% Group PostFES
[B_g2,twom_g2] = multicat(A_g2, 1, 1);
...
%%7di. Consensus Community Detection
...
multi_comm_indivi_g1 = multilayer_community_detection_individual(...
    A_g1, 'cat', 100, 'max', 1, 1);  % A_g1, 'cat', 100, 'max', gamma, omega

multi_comm_indivi_g2 = multilayer_community_detection_individual(...
    A_g2, 'cat', 100, 'max', 1, 1); 
