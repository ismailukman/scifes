...
filename = sprintf('S_indivi_g3_gamma%.1f,%.1f.mat', gamma, log_omega); save(filename,'N_all_g3');
filename = sprintf('S_group_g3_gamma%.1f,%.1f.mat', gamma, log_omega); save(filename,'N_all_group_g3');
